...
public class AarogyaHospital{
 ...
 static void display(AarogyaHospital.AarogyaMember patient){
   ...
   System.out.println(patient.id+" "+patient.name+" "+patient.gender+" "+patient.age+" "+patient.aadharNumber+" "+patient.city+" "+patient.guardianName+" "+patient.recovered);
        ...
        System.out.println("Invalid option, Please check once! ");
			...
			// to print all the patients from a particular city (take city as input)
                  ...
                  while(itr.hasNext()){
                    ...
                    if(!found){
                      System.out.println("There is no memeber with such id : "+city);
                    }
	               }
